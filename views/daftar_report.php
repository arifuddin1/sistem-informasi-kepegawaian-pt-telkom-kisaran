        ...
        <div class="col-xs-12">
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Laporan Data Pegawai</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9">
                                    <a href="report/daftar_semua.php" target="_blank" class="btn btn-danger btn-sm">
                                        <span class="fa fa_print"></span> Cetak Data Pegawai
